...
long zipf_next(void); // zipf distribution, call init_zipf_generator first
long uniform_next(void); // uniform, call init_zipf_generator first
long bogus_rand(void); // returns something between 1 and 1000
